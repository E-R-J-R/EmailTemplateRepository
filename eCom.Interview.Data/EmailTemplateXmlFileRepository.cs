...
using eComEngine.Interview.Data.Private;
...
namespace eComEngine.Interview.Data
{
    ...
    public class EmailTemplateXmlFileRepository : IRepository<EmailTemplate>
    {
        ...
        public Task<IQueryable<EmailTemplate>> Templates()
        { 
            return Task.FromResult(templates.AsQueryable());
        }
    }
}

namespace eComEngine.Interview.Data.Private
{
    /// <summary>
